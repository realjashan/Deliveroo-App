...
const RestaurantScreen = () => {
  ...
  const {
//sending id,imgUrl....and all via url from restaurantCard//
  ...
  dispatch(setRestaurant({
   ...
   //fetching from restaurant screen to send to global store in whatver restaurant we are in// 
    id,
    imgUrl,
    title,
    rating,
        ...
        <View className="px-4 pt-4">
          ...
          <View className="flex-row space-x-2 my-1">
            <View className="flex-row items-center space-x-1">
              <StarIcon size={22} color="green" opacity={0.3} />
